  ...
  return (
    <div>
      ...
      <div className="space-y-2 p-4 pt-0">
        <ToggleButton action={setVendorArchived.bind(null, id, !vendor.archived)} label={vendor.archived ? "Unarchive vendor" : "Archive vendor"} toastMessage={vendor.archived ? "Vendor restored" : "Vendor archived"} />
