// Country name -> international dialing code. Keys match src/lib/countries.ts.
// Used to auto-prefill the phone fields once a country is chosen, so users only
// type the local part and WhatsApp links work worldwide.
export const DIAL_CODES: Record<string, string> = {
  ...
  "Germany": "+49", "Ghana": "+233", "Greece": "+30", "Grenada": "+1",
  ...
  "Vatican City": "+39", "Venezuela": "+58", "Vietnam": "+84", "Yemen": "+967",
  "Zambia": "+260", "Zimbabwe": "+263",
};

// A phone value that is only a dial code (e.g. "+49" or "+971 ") — no local
// number typed. Used to avoid saving a bare prefix.
export function isBareDialCode(value: string): boolean {
